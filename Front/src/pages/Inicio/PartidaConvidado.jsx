...
const PartidaConvidado = () => {
    ...
    useEffect(() => {
        const fetchContatos = async () => {
            const novosContatos = await Promise.all(partidas.map(async (partida) => {
                const data = {
                    equipe_id: partida.equipe_mandante_id
                };
            ...
            // Atualize o estado com os novos contatos
    ...
    useEffect(() => {
        ...
        api.post('partida/andamento', data, headers)
            .then(response => {
...
export default PartidaConvidado;
